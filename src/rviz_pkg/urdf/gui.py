...
class Gui(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        self.startMission.clicked.connect(self.start_missionTimer)
        self.resetMission.clicked.connect(self.reset_missionTimer)
        self.stopMission.clicked.connect(self.stop_missionTimer)
        ...
        self.floatButton.clicked.connect(lambda: self.stackedWidget2.setCurrentIndex(0))
        self.depthButton.clicked.connect(lambda: self.stackedWidget2.setCurrentIndex(2))
        self.floatReturnButton.clicked.connect(lambda: self.stackedWidget2.setCurrentIndex(1))
    ...
    def stop_missionTimer(self):
        self.mission_timer.stop()

    def reset_missionTimer(self):
        self.stop_missionTimer()
        self.mission_elapsed_time = 0
        self.missionTimerLCD.display(str(QTime(0, 0, 0).toString("mm:ss")))
